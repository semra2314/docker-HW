...
1.  **Ara Katmanı Başlatın**:
    ...
    ```
    *(Konsolda `[Middleware] Sunucu başlatıldı: ('0.0.0.0', 9999)` yazısını göreceksiniz.)*
...
2.  **Veri Üreticiyi Başlatın**:
    ...
    ```
    *(Veri üretici hemen bağlanacak ve log akışını başlatacaktır. Ekranda saniyelik performans raporları akmaya başlayacaktır.)*
